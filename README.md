...
| **Проект** | **Тип исследования** | **Статус** |
| ---------- | :------------------- |:----------:|
| [01. Архитектор данных (1T).](https://github.com/Leshakot/data_1t) |Проект представляет собой контейнер, который подключается к базе данных PostgreSQL, создает таблицу, заполняет ее данными и выполняет запрос. | Завершен |

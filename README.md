...
| [03.  РМ](https://github.com/Leshakot/data_analyst/blob/main/business_indicators/Analysis_business_indicators.ipynb) |Рассчитаны различные метрики, использован когортный анализ: LTV, CAC, Retention rate, DAU, WAU, MAU и т.д.| Завершен |

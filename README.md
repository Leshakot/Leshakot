...
| [06. SQL в COLAB](https://github.com/Leshakot/SQL/blob/main/Sql_in_colab/_sql_YP_tetst_ipynb_.ipynb) |Подключение к базе данных, пример запросов, извлечение результатов, визуализация данных| Завершен |
<br>
...
---
<h3 align="center"> Проекты Docker </h3>

| **Проект** | **Тип исследования** | **Статус** |
| ---------- | :------------------- |:----------:|
| [01. Архитектор данных (1T).](https://github.com/Leshakot/devops/tree/main/data_1t) |Проект представляет собой контейнер, который подключается к базе данных PostgreSQL, создает таблицу, заполняет ее данными и выполняет запрос. | Завершен |
| [02. JupyterHub in Docker.](https://github.com/Leshakot/devops/tree/main/jupyterhub_in_docker) | Проект разворачивает JupyterHub в контейнере Docker, предоставляя доступ к Jupyter-ноутбукам с возможностью многопользовательской работы. JupyterHub подключается к внешнему контейнеру PostgreSQL через пользовательскую Docker-сеть. Проект демонстрирует изоляцию сервисов и их взаимодействие в распределённой среде. | В работе |
